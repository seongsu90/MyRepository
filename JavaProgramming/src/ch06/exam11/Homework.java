		...
		while ( true ) {
			...
			if ( choice.equals("1") ) {
				...
				for ( int i = 0 ; i < board.length ; i++ ) {
					if( board[i] == null ) {
						Board b1 = new Board(i,title,writer,content,0);
						board[i] = b1;
						break;
					}
				}
				...
				if ( board[num] == null ) {
					...
					board[num].setbHitCount(board[num].getbHitCount()+1);

					// 번호, 제목, 글쓴이, 조회수, 내용 출력
					System.out.println("번호 : " + board[num].getBno());
					System.out.println("제목 : " + board[num].getBtitle());
					System.out.println("글쓴이 : " + board[num].getBwriter());
					System.out.println("조회수 : " + board[num].getbHitCount());
					System.out.println("내용 : ");
					System.out.println(board[num].getBcontent());
				}
				...
				if ( board[num] == null ) {
					...
					while ( true ) {
						...
						if ( modNum == 3 ) {
							...
							System.out.println("현재 제목은 \"" + board[num].getBtitle() + "\"입니다.");
							System.out.print("수정할 제목을 입력 하세요 : ");
							board[num].setBtitle( scanner.nextLine());
							System.out.println("수정되었습니다. ");
							break;
						} else if ( modNum == 2 ) {
							System.out.println("현재 내용은 \"" + board[num].getBcontent() + "\"입니다.");
							System.out.print("수정할 내용을 입력 하세요 : ");
							board[num].setBcontent( scanner.nextLine());
							System.out.println("수정되었습니다. ");
							break;
						} else {
